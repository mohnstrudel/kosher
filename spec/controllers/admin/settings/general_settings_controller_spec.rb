...
RSpec.describe Admin::Settings::GeneralSettingsController, type: :controller do
  before(:each) do
    @already_created = FactoryBot.create(:general_setting, language: {"ru" => "ru", "en" => "en"})
  end
  ...
  login_superadmin
  # let(:action) { post :create, params: { general_setting: FactoryBot.attributes_for(:general_setting) } }

  context 'POST methods' do
    describe 'post create' do
      it "saves the record with valid attributes" do
        # expect{
        #   post :create, params: { general_setting: FactoryBot.attributes_for(:general_setting) }
